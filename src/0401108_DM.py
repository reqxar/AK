...
# Настройки
docStartDateBegin = '13.08.2021' # Дата начала периода
docStartDateEnd = '13.08.2021' # Дата окончания периода

file_quantity = 2000 # Количество файлов
doc_quantity = 4000 # Количество документов в файле
    ...
    for operation_day in Requisite.get_date_range(docStartDateBegin, docStartDateEnd):
        for i in range(round(file_quantity / thread_count)):
            ...
            for n in range(doc_quantity):
                ...
                AK.random_string('formCode', ['0401108_DM'])
