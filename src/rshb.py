...
# Настройки
docStartDateBegin = '01.10.2021' # Дата начала периода
docStartDateEnd = '15.10.2021' # Дата окончания периода

file_quantity = 700 # Количество файлов
doc_quantity = 1500 # Количество документов в файле
